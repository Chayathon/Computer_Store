<?php
    ...
    $search_ordered = $_GET['search_ordered'];
    
    $sql = "SELECT * FROM cs_ordered AS o
    INNER JOIN cs_user AS u ON o.u_id = u.u_id
    INNER JOIN cs_address AS a ON o.a_id = a.a_id
    WHERE u.u_user LIKE '%$search_ordered%'
    OR o.o_product LIKE '%$search_ordered%'
    OR o.o_bank LIKE '%$search_ordered%'
    OR o.o_date LIKE '%$search_ordered%'
    OR o.o_status LIKE '%$search_ordered%'
    OR o.parcel_number LIKE '%$search_ordered%'
    ORDER BY o_id ASC";
                            ...
                            <form method="post" action="update_ordered">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-floating">
                                        <input type="text" class="form-control" name="parcel_number" id="parcel_number" value="<?php echo $row['parcel_number']; ?>" placeholder="Parcel Number">

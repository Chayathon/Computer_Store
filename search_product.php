<?php
    ...
    WHERE p.p_name LIKE '%$search_product%'
    OR t.t_name LIKE '%$search_product%'
    OR p.p_detail LIKE '%$search_product%'
    OR p.p_price LIKE '%$search_product%'
    ORDER BY p_id ASC";
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="form-horizontal was-validated" name="update" id="update" method="post" enctype="multipart/form-data" action="update_product.php">
                            ...
                            <div class="form-floating mb-2">
                                <input class="form-control is-valid" type="text" name="p_amount" id="p_amount" placeholder="Amount" value="<?php echo $row['p_amount'];?>" required>

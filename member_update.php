                ...
                <center>
                    <div class="col-md-4">
                        <div class="shadow-lg p-3 mb-5 bg-body rounded">
                            <form class="form-horizontal was-validated" action="member_update_db.php" name="member_update" id="member_update" method="POST">
                                <h3>Edit Profile</h3>
                                <p></p>
                                ...
                                <div class="form-floating mb-2">
                                    <input type="text" class="form-control is-valid" name="u_user" id="u_user" placeholder="Username" value="<?php echo $u_user;?>" required>
                                ...
                                <div class="form-floating mb-3">
                                    <input type="email" class="form-control is-valid" name="u_email" id="u_email" placeholder="E-mail" value="<?php echo $u_email;?>" required>
